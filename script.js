document.addEventListener('DOMContentLoaded', function () {
  ...
  function addTodo() {
    ...
    const tahun = document.getElementById('date').value;
   
    const generatedID = generateId();
    const todoObject = generateTodoObject(generatedID, Penulis, judul, tahun, false);
  ...
  function generateTodoObject(id, Author, title, year, isCompleted) {
    return {
      id,
      Author,
      title,
...
document.addEventListener(RENDER_EVENT, function () {
  ...
  function makeTodo(todoObject) {
    ...
    textTimestamp.innerText = todoObject.year;
